...
@Route("/target")
public class TargetHandler extends GeneralHandler {
    ...
    public Response get(UriResource uriResource, Map<String, String> urlParams, IHTTPSession session) {
		try {
			...
			JSONArray results = TARGET.getStatus(zip, query, params.containsKey("expand") && params.get("expand").contains("true"));
