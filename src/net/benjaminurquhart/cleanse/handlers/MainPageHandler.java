...
public class MainPageHandler extends GeneralHandler {
    ...
    public Response get(UriResource uriResource, Map<String, String> urlParams, IHTTPSession session) {
		try {
			...
			out.put("warning", "The /target/ endpoint can take a VERY long time to return results. This is due to the internal structure of the Target API and cannot be avoided.");
