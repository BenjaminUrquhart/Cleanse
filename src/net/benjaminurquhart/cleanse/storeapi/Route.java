...
public enum Route {
	...
	TARGET_SEARCH("https://redsky.target.com/v2/plp/search/?pricing_store_id=%s&store_ids=%s&keyword=%s&pageId=%s&channel=web&count=24&default_purchasability_filter=true&facet_recovery=false&isDLP=false&offset=0&kwr=y", APIKey.TARGET),
